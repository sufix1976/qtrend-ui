...
export default function AppTESTv3() {
  ...
  }, [symbol, interval, entryBandUI, peakUI, minKinkUI, smaFastUI, smaSlowUI, assumedSpread, assumedSlippage, counterTrendExitKinkUI]);
    ...
    >
      ...
      >
        ...
        <div style={{ marginTop: 10, borderTop: "1px solid #334155", paddingTop: 8 }}>
          <div style={{ fontWeight: 700, marginBottom: 6 }}>⚙️ Parameter TEST V3</div>
        ...
        <div style={{ marginTop: 8, borderTop: "1px solid #334155", paddingTop: 8, fontSize: 12 }}>
          ...
          <div style={{ color: "#94a3b8" }}>TEST V3: Gegentrend-Exit aktiv</div>
