...
export default function TrendBuilder(){
 ...
 return <div style={{padding:14,color:"#dbeafe",background:"#050b12",minHeight:"100vh",fontFamily:"Inter,system-ui"}}>
  ...
  <div style={{marginTop:10,color:"#94a3b8",fontSize:12}}>V4.1: Die bestätigten instrumentbezogenen LIVE-LRC-Favoriten T37/T40/T41/T42/T43/T44 sind gespeichert. Beim Instrumentwechsel wird automatisch dessen Lock geöffnet. Research only – Live-Trading, Controller und Profile unverändert.</div>
 </div>
}