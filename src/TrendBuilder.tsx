...
export default function TrendBuilder(){
 ...
 return <div style={{padding:14,color:"#dbeafe",background:"#050b12",minHeight:"100vh",fontFamily:"Inter,system-ui"}}>
  ...
  <div style={{marginTop:10,color:"#94a3b8",fontSize:12}}>V6: T59–T70 = LIVE TURN DETECTOR. Jeder Zustand wird ausschließlich aus Daten bis zur aktuellen 1m-Kerze berechnet. Ein Turn erscheint auf der Kerze, auf der ATR-Reversal + Mindestabstand erstmals erfüllt sind – niemals rückwirkend am früheren Hoch/Tief. Kein Backpaint/Repainting. Bestehende LIVE-LRC-Locks bleiben unverändert; Research only.</div>
 </div>
}