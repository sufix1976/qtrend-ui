...
export default function TrendBuilder(){
 ...
 return <div style={{padding:14,color:"#dbeafe",background:"#050b12",minHeight:"100vh",fontFamily:"Inter,system-ui"}}>
  ...
  <div style={{marginTop:10,color:"#94a3b8",fontSize:12}}>V7: T71–T80 = HH/HL MARKET STRUCTURE. Lokale Swing-Highs/Lows werden erst nach den rechten Bestätigungsbars bekannt. LONG/SHORT ändert sich nur aus der bestätigten Folge höherer/tieferer Swing-Extrema; die Ausgabe erfolgt auf der Erkennungskerze und wird niemals zurückgemalt. Bestehende LIVE-LRC-Locks bleiben unverändert; Research only.</div>
 </div>
}