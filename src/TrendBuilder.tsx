...
export default function TrendBuilder(){
 ...
 return <div style={{padding:14,color:"#dbeafe",background:"#050b12",minHeight:"100vh",fontFamily:"Inter,system-ui"}}>
  ...
  <div style={{marginTop:10,color:"#94a3b8",fontSize:12}}>V3.4: STRICT CAUSAL. Higher-TF-Trends werden erst nach Abschluss der jeweiligen 8h/10h/12h/14h/1D/2D/3D-Kerze freigegeben; keine fertige HTF-Kerze wird rückwirkend in ihren Block gemalt. Die bisherigen instrumentbezogenen Locks bleiben nur als Vergleichsauswahl erhalten und müssen jetzt visuell neu bestätigt werden. Research only – Live, Controller und Profile unverändert.</div>
 </div>
}