...
export default function TrendBuilder(){
 ...
 return <div style={{padding:14,color:"#dbeafe",background:"#050b12",minHeight:"100vh",fontFamily:"Inter,system-ui"}}>
  ...
  <div style={{marginTop:10,color:"#94a3b8",fontSize:12}}>V3.2: T22 = 12h / L6 bleibt Favorit. T25–T34 fächern eng darum auf: 12h L4/5/7/8 sowie 10h und 14h mit L5/6/7. Alles kausal; noch keine Übernahme in Live oder Optimizer.</div>
 </div>
}