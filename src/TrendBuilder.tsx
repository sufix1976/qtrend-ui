...
export default function TrendBuilder(){
 ...
 return <div style={{padding:14,color:"#dbeafe",background:"#050b12",minHeight:"100vh",fontFamily:"Inter,system-ui"}}>
  ...
  <div style={{marginTop:10,color:"#94a3b8",fontSize:12}}>V3.1: T13–T18 sind die langsamen LRC-Control-Varianten. T19–T24 sind schnellere kausale Varianten auf 1D, 12h und 8h. T15 bleibt die 2D / Length 8 Referenz.</div>
 </div>
}