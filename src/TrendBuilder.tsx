...
export default function TrendBuilder(){
 ...
 return <div style={{padding:14,color:"#dbeafe",background:"#050b12",minHeight:"100vh",fontFamily:"Inter,system-ui"}}>
  ...
  <div style={{marginTop:10,color:"#94a3b8",fontSize:12}}>V4: T35–T46 = LRC LIVE. Die laufende Higher-TF-Kerze wird auf jeder vorhandenen 1m-Kerze nur mit den bis dahin bekannten OHLC-Daten neu berechnet. Dadurch darf der Trend innerhalb des HTF-Blocks früh drehen, ohne den späteren Schlusskurs zu kennen. Research only – Live-Trading, Controller und Profile unverändert.</div>
 </div>
}